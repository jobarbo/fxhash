class Texture {
	...
	display() {
		...
		this.yoff += this.mask.width / 100000;
		this.woff1 += this.mask.width / 1454.55;

		let w1 = map(noise(this.woff1 + this.rdnW1), 0, 1, 0, this.mask.width / 1000);
		...
		this.mask.noStroke();
		this.mask.rect(x + offset, y - offset, w1, w1);
		this.mask.fill(this.hue, 0, this.bri, this.alpha + 20);
		this.mask.noStroke();
